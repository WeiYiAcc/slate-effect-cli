    ...
    serve: Effect.fnUntraced(function* (httpApp, middleware) {
      ...
      function handler(request, server) {
        return new Promise((resolve, _reject) => {
          const context = Context.add(services, ServerRequest.HttpServerRequest, new BunServerRequest(request, resolve, removeHost(request.url), server, compressionThreshold));
