import type { ContentBlock, Implementation, McpServer, RequestPermissionRequest, RequestPermissionResponse, SessionConfigOption, SessionUpdate, StopReason } from "@agentclientprotocol/sdk";
export type { ContentBlock, McpServer, SessionConfigOption, SessionUpdate, StopReason, };
...
type FlatAcpSessionUpdate<Update extends SessionUpdate = SessionUpdate> = Update extends SessionUpdate ? Omit<Update, "sessionUpdate"> & {
...
export type DurableSessionUpdateEntry = DurableSessionEventEnvelope & AcpSessionEvent;
...
export type DurableSessionEventEntry = DurableSessionUpdateEntry | DurablePermissionRequestEntry | DurablePermissionResponseEntry;
export type EphemeralSessionEventEntry = EphemeralSessionEventEnvelope & FlatAcpSessionUpdate<Extract<SessionUpdate, {
    sessionUpdate: "agent_message_chunk" | "agent_thought_chunk";
}>>;
export type SessionStreamEntry = DurableSessionEventEntry | EphemeralSessionEventEntry;
...
export type PermissionTerminalReason = "already_resolved" | "prompt_cancelled" | "adapter_exited" | "session_deleted" | "vm_shutdown" | "request_not_found";
