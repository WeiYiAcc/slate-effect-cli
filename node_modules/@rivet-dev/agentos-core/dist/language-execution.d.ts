...
export type ExecutionSignal = "SIGHUP" | "SIGINT" | "SIGQUIT" | "SIGTERM" | "SIGKILL" | "SIGSTOP" | "SIGCONT" | "SIGUSR1" | "SIGUSR2";
...
export interface TypeScriptFileExecutionOptions extends LanguageExecutionOptions {
    tsconfigPath?: string;
    compilerOptions?: Record<string, JsonValue>;
}
...
export interface NpmProjectInstallOptions extends Omit<LanguageExecutionOptions, "args" | "stdin"> {
    frozen?: boolean;
}
export interface NpmPackageInstallOptions extends Omit<LanguageExecutionOptions, "args" | "stdin"> {
    dev?: boolean;
    global?: boolean;
}
export interface PythonInstallOptions extends Omit<LanguageExecutionOptions, "args" | "stdin"> {
    upgrade?: boolean;
    requirementsFile?: string;
    indexUrl?: string;
    extraIndexUrls?: string[];
}
export type ContextState = "idle" | "running" | "resetting" | "deleting" | "failed";
...
type ExecutionResultOutcome<TIdentity> = (CodeExecutionResultBase & {
    outcome: "succeeded";
    error?: never;
} & TIdentity) | (CodeExecutionResultBase & {
...
export type CodeEvaluationResult<T = JsonValue> = (CodeExecutionResultBase & {
    outcome: "succeeded";
    error?: never;
    value: T;
...
export type TypeScriptCheckResult = (CodeExecutionResultBase & {
    outcome: "succeeded";
    error?: never;
    hasErrors: boolean;
