...
export interface FsDriverTestCapabilities {
    ...
    mkdir: boolean;
    removeDir: boolean;
    allowMissingFileRemoveNoop: boolean;
    allowMissingDirReadAsEmpty: boolean;
    allowMissingSourceRenameNoop: boolean;
    allowDirectoryRenameUnsupported: boolean;
    allowSymlinkLoopErrnoFallback: boolean;
    allowDirectoryHardLink: boolean;
    allowMkdirWithoutRecursiveParentAutoCreate: boolean;
    allowRemoveDirNonEmptyRecursiveDelete: boolean;
    allowSymlinkOverwrite: boolean;
}
