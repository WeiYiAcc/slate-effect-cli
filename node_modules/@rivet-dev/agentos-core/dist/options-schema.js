...
const vmUserConfigSchema = z
    ...
    .strict();
const functionSchema = z.custom((value) => typeof value === "function", { message: "Expected function" });
...
export const agentOsOptionFieldSchemas = {
    ...
    sandbox: z
        ...
        (typeof value === "object" && value !== null && !Array.isArray(value)), { message: "Expected sandbox options object" })
        .optional(),
    scheduleDriver: z
...
export const agentOsOptionsSchema = z
    ...
    .strict();
export function parseAgentOsOptions(options) {
