 ...
 */
import type { AgentosPackageManifest, PackageAgentDescriptor, PackageRef as ManifestPackageRef } from "@agentos-software/manifest";
/** Root of the agentOS package tree inside the VM. */
export declare const OPT_AGENTOS_ROOT = "/opt/agentos";
/** The symlink farm on `$PATH` (commands link here). */
export declare const OPT_AGENTOS_BIN = "/opt/agentos/bin";
...
export declare function isPackageDescriptor(value: unknown): value is PackageDescriptor;
export declare function readAgentosPackageManifest(dir: string): AgentosPackageManifest;
export declare function tryReadAgentosPackageManifest(dir: string): AgentosPackageManifest | undefined;
