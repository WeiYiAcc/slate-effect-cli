...
export type JsonRpcErrorData = AcpTimeoutErrorData | UnknownSessionErrorData | Record<string, unknown>;
...
export declare function isAcpTimeoutErrorData(value: unknown): value is AcpTimeoutErrorData;
export declare function isUnknownSessionErrorData(value: unknown): value is UnknownSessionErrorData;
