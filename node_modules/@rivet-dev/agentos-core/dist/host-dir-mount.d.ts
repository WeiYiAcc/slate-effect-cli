import type { MountConfigJsonObject, NativeMountPluginDescriptor } from "@rivet-dev/agentos-runtime-core/descriptors";
 ...
 */
export declare function createHostDirBackend(options: HostDirBackendOptions): NativeMountPluginDescriptor<HostDirMountPluginConfig>;
 ...
 */
export declare function nodeModulesMount(hostNodeModulesDir: string, opts?: {
    readOnly?: boolean;
