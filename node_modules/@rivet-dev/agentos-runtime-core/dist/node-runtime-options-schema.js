...
export const nodeRuntimePermissionsSchema = z
    ...
    .strict();
const uint8ArraySchema = z.custom((value) => value instanceof Uint8Array, { message: "Expected Uint8Array" });
...
const bindingDefinitionSchema = z
    .object({
    description: z.string(),
    inputSchema: z.custom((value) => typeof value === "object" && value !== null, { message: "Expected JSON Schema object" }),
    timeoutMs: z.number().int().nonnegative().optional(),
    examples: z.array(bindingExampleSchema).optional(),
    commandAliases: stringArray.optional(),
    handler: z.custom((value) => typeof value === "function", { message: "Expected function" }),
})
    .strict();
/**
...
export const nodeRuntimeCreateOptionsSchema = z
    .object({
    filesystem: z.custom((value) => typeof value === "object" && value !== null, { message: "Expected caller-owned VirtualFileSystem object" }),
    ...
    sidecar: z
        ...
        .optional(),
    onBootTiming: z
        .custom((value) => typeof value === "function", { message: "Expected function" })
        .optional(),
    files: z
    ...
    .strict();
export function parseNodeRuntimeCreateOptions(options) {
